classdef class_accessory_data
    ...
    %   Holds accessory data as specified by GUNC
    ...
    methods
        ...
        function obj = set.torque_ftlbs( obj, val )
            obj.torque_Nm = convert.ftlbs2Nm * val ;
        end
        
        function val = get.torque_ftlbs( obj )
            val = convert.Nm2ftlbs * obj.torque_Nm;
        end
        ...
        function obj = set.mechanical_hp( obj, val )
            obj.mechanical_kW = convert.hp2kW * val ;
        end
        
        function val = get.mechanical_hp( obj )
            val = convert.kW2hp * obj.mechanical_kW;
        end
        %% filtering functions
