function write_param_tab( xls, sheet, data, engine, output_type_label)
...
xls.write({[engine.name, ' Engine ',engine.fuel,' - '  output_type_label, ' Data']},'A1')
xls.format(xlsrange( 'A', 1, 3), 'MergeCells',true,'FontSize',16,'FontBold',true);

xls.write({engine.fuel_description},'A2')
xls.format(xlsrange( 'A', 2, 3), 'MergeCells',true);
